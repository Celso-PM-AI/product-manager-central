...
Open an existing product and choose Create Document. Select BRD or PRD, review
the deterministic prepopulation, complete any additional guided fields, and
save. New documents default to version `1.0` and Draft status.
